...
Livro* pedirISBN(Biblioteca &biblioteca)
{
    ...
    while (validade)
    {
        ...
        {
            cout << "ISBN nao existente. Tente novamente..." << endl << endl;
        }
    }
...
void menuAlteracaoInformacao(Biblioteca &biblioteca)
{
    ...
    Livro* livro_a_alterar = pedirISBN(biblioteca);

    cout << endl << "Novo local: ";
    getline(cin, novo_local);

    confirmarAlteracao(biblioteca);
    livro_a_alterar->setLocal(novo_local);
...
void mainMenu(Biblioteca &biblioteca)
{
    ...
    cout << endl << "** Biblioteca **" << endl
         << "[1] Lista de todos os livros" << endl
         << "[2] Lista de uma categoria de livros" << endl
         << "[3] Procurar livro " << endl
         << "[4] Alterar localizacao de um livro" << endl
         << "[5] Adicionar livro " << endl
         << "[6] Remover livro " << endl
         << "[7] Sair" << endl;
